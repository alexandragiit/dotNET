...
namespace MyPhotosGui
{
    public partial class Form1 : Form
    {
        ...
        readonly InterfaceWCFClient api = new InterfaceWCFClient();
        
        //resAPI api = new resAPI();
        internal void LoadPhotos(List<resourcesDTO> r )
        {
            loc = new Point(50, 80);
        ...
        private void BtnSearch_Click(object sender, EventArgs e)
        {
            ...
            List<resourcesDTO> r = api.getResourcesByQueryAtribute(comboBoxAtr.Text, search);
            LoadPhotos(r);
            AddEventHndOnImg();
            if (r.Count() >= 1)
                loadMain(r[0].path);
        ...
        private void init()
        {
            /*var r = api.getAllAtribtuesForResource("D:\\movie\\I.Origins.2014.1080p.BluRay.H264.ACC.5.1.BADASSMEDIA\\1.JPG");
            TextBoxSearch.Text = r[0].resources_resID.ToString();*/
        ...
        private void BtnPhotos_Click(object sender, EventArgs e)
        {
            ...
            var torm = new List<resourcesDTO>();
            foreach(var i in r)
            {
                if(i.type == "video")
                {
        ...
        private void BtnVideos_Click(object sender, EventArgs e)
        {
            ...
            foreach (var i in r)
            {
                Console.WriteLine(i.type + i.path);
            }
            LoadPhotos(r);
            AddEventHndOnImg();
            if (r.Count() >= 1)
